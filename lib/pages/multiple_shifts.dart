...
class MultipleShifts extends StatelessWidget {
  @override
  ...
  double fem = MediaQuery.of(context).size.width / 430;
    ...
    Container(
      ...
      child: Container(
        padding: EdgeInsets.fromLTRB(0*fem, 0*fem, 0*fem, 4.8*fem),
        child: Column(
          ...
          children: [
                                    ...
                                    Container(
                                      ...
                                      child: Container(
                                        ...
                                        child: SizedBox(
                                          ...
                                          height: 0.9*fem,
                                          child: SvgPicture.asset(
                                            'assets/vectors/iconbattery_full_15_x2.svg',
                                          ),
                                        ),
                                      ),
                                    ),
            ...
            Container(
              margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 0.1*fem, 2.2*fem),
              child: Text(
            ...
            Container(
              ...
              child: Text(
                'Manage And Track Your Empolyee’s Attendance Efficiently Using CheckMat',
              ...
              child: Container(
                decoration: BoxDecoration(
                  image: DecorationImage(
                    fit: BoxFit.cover,
                    image: AssetImage(
                      'assets/images/whats_app_image_20240827_at_00041650210_cb_5.jpeg',
                    ),
                  ),
                ),
                child: Container(
            ...
            Container(
              margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 0.1*fem, 3.8*fem),
              child: SizedBox(
                width: 4.2*fem,
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.start,
