      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
                                    ...
                                    Container(
                                      ...
                                      child: Container(
                                        ...
                                        child: SizedBox(
                                          ...
                                          height: 0.9*fem,
                                          child: SvgPicture.asset(
                                            'assets/vectors/iconbattery_full_9_x2.svg',
                                          ),
                                        ),
                                      ),
                                    ),
            ...
            Container(
              margin: EdgeInsets.fromLTRB(1.1*fem, 0*fem, 1.1*fem, 4.3*fem),
              child: Text(
              ...
              child: Container(
                decoration: BoxDecoration(
                  image: DecorationImage(
                    fit: BoxFit.cover,
                    image: AssetImage(
                      'assets/images/whats_app_image_20240827_at_000417_dd_9460_c_0.jpeg',
                    ),
                  ),
                ),
                child: Container(
            ...
            Container(
              margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 0.1*fem, 3.1*fem),
              child: SizedBox(
                width: 4.2*fem,
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.start,
            ...
            Container(
              margin: EdgeInsets.fromLTRB(0.9*fem, 0*fem, 0*fem, 2.3*fem),
              child: Container(
                decoration: BoxDecoration(
                  color: Color(0xFF066DF2),
